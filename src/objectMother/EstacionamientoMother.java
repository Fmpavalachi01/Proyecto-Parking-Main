...
public ArrayList<Estacionamiento> estacionamientoMother(){
	...
	String[] matriculas= {"123","pruebaMat","matricula","matricula2"};
	LocalTime[] horas= {LocalTime.of(12, 30),LocalTime.of(14, 0),LocalTime.of(1, 12),LocalTime.of(12, 01)};
	LocalDate[] dias= {LocalDate.of(2022, 6, 4),LocalDate.of(2022, 6, 7),LocalDate.of(2022, 5, 30),LocalDate.of(2022, 6, 3)};
